...
<head>
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysql_query("UPDATE berita SET berita_judul='$berita_judul', berita_headline='$berita_headline',berita_isi='$berita_isi', berita_author='$berita_author', berita_tanggal='$berita_tanggal' WHERE berita_id='$berita_id'");
		if($query){
...
<form method="POST">
	...
	<table>
		<tr>
			<td>Judul Berita</td>
			<td><input type="text" name="berita_judul" value="<?php $hasil[1]?>"></td>
		</tr>
		<tr>
			<td>Headline Berita</td>
			<td><input type="text" name="berita_headline" value="<?php $hasil[2]?>"></td>
		</tr>
		<tr>
			<td>Isi Berita</td>
